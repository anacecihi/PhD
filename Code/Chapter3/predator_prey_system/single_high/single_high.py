...
ancestral_parasite = 0 # free-living parasites
...
time_steps = 1 # introduce new genotype every x time steps (total number of introductions)
...
# invasive genotypes
invasive_parasite = np.ones(n_loci) # create new invader genotype
...
### Array for simulations ###
    if Time >= invasion_Time_parasite and invasion_parasite == True: # super-resistant parasite genotype emerges
...
### Array for storage ###
        ...
        invasion_parasite = False # switch-off loop for just introducing the first genotype once
        invasion_Time_parasite += 1 # let simulations run and introduce next genotype when time reaches one more time step

### Reeintroduce invasive genotypes ###
### Array for simulations ###
