...
# First invader
invasive_parasite = np.zeros(n_loci)
invasive_parasite[position] = 1
position += 1
...
### New genotype ###
    if Time >= time_new_genotype and Time <= final_invasion_Time_parasite: # super-resistant parasite genotype emerges
        invasive_parasite = np.zeros(n_loci)
        invasive_parasite[position] = 1
        position += 1
...
### Array for simulations ###
    if Time >= invasion_Time_parasite and invasion_parasite: # super-resistant parasite genotype emerges
