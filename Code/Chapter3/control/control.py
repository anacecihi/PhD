...
# invasion
invasion_Time_parasite = 0 # initial time of introduction of invasive genotypes
time_steps = 0 # introduce new genotype every x time steps (total number of introductions)
final_invasion_Time_parasite = 0 # time limit of introduction of invasive genotypes
invasion_Ind_parasite = 0 # number of invader individuals
invasion_parasite = False
max_time = 1000
recording_time = 400
